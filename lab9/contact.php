<?php
/**
 * contact.php - Formularz kontaktowy i przypominanie hasła
 */

/**
 * WyslijMailNaKontakt - Wysyła wiadomość email
 * @param string $emailOdbiorcy Adres email odbiorcy
 * @param string $temat Temat wiadomości
 * @param string $wiadomosc Treść wiadomości
 * @return bool true jeśli wysłano, false w przypadku błędu
 */
...
/**
 * PrzypomnijHaslo - Wysyła email z przypomnieniem hasła
 * @param string $email Adres email użytkownika
 * @return bool true jeśli wysłano, false w przypadku błędu
 * @uses WyslijMailNaKontakt()
 */
...
/**
 * PokazKontakt - Wyświetla formularze kontaktowe
 */
