<?php
/**
 * index.php - Główny plik aplikacji z menu bocznym i routingiem
 * Obsługuje połączenie z bazą danych i wyświetlanie podstron
 */
...
// Mapowanie parametru 'idp' z URL na pliki HTML (starsza wersja routingu)
...
<body<?php if($_GET['idp'] == 'Timedate') echo ' onload="startclock()" style="background-image: none;"'; ?>>
    ...
    <?php
    // Pobranie parametru 'idp' z URL i wyświetlenie treści podstrony
    ...
    <?php 
    // Ładowanie skryptów JavaScript tylko na stronie Timedate
    if($_GET['idp'] == 'Timedate'): ?>
